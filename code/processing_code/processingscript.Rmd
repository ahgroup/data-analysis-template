...
This contains the same code and comments/information as processingscript.R

This just shows it as Rmd file, to give you an idea how to do it in either setup.

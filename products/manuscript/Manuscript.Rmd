...
Example figure \@ref(fig:resultfigure) shows a result produced by one of the R scripts.
...
Example table \@ref(tab:resulttable) shows a result table from the analysis.
